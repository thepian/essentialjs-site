...
DATABASE_NAME = '/Sites/essentialjs/devdb'
DATABASE_USER = ''
DATABASE_PASSWORD = ''
DATABASE_HOST = ''
DATABASE_PORT = ''

DOMAINS = ('essentialjs.dev.local',)
MEDIA_DOMAIN = 'media.essentialjs.dev.local'

from settings import *

MEDIA_URL = 'http://media.essentialjs.dev.local'
ADMIN_MEDIA_PREFIX = MEDIA_URL+'/admin/'
TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/Sites/essentialjs/templates',
)
